...
var get_balance = function (addr) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Completium.getBalance(addr.toString())];
            case 1:
                b = _a.sent();
