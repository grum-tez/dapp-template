...
const make_arg = (expr, pi) => {
    if (pi.length == 1) {
        const [n] = pi;
        return typescript_1.factory.createElementAccessExpression(typescript_1.factory.createPropertyAccessExpression(expr, typescript_1.factory.createIdentifier("args")), typescript_1.factory.createNumericLiteral(n));
    }
    else if (pi.length == 2) {
        const [start, end] = pi;
...
const archetype_type_to_mich_type = (at, ci) => {
    switch (at.node) {
        ...
        case "tx_rollup_l2_address": return { prim: at.node };
...
const archetype_type_to_ts_type = (at, ci) => {
    ...
    switch (at.node) {
        ...
        case "tx_rollup_l2_address": return typescript_1.factory.createTypeReferenceNode(typescript_1.factory.createQualifiedName(typescript_1.factory.createIdentifier("att"), typescript_1.factory.createIdentifier("Tx_rollup_l2_address")), undefined);
...
const function_param_to_mich = (fp, ci) => {
    ...
    switch (fp.type.node) {
        ...
        case "tx_rollup_l2_address": return class_to_mich(typescript_1.factory.createIdentifier(fp.name));
...
const value_to_mich_type = (mt) => {
    ...
    switch (mt.prim) {
        ...
        case "tx_rollup_l2_address": return for_simple_type(mt.prim, (_z = mt.annots) !== null && _z !== void 0 ? _z : []);
        case "unit": return for_simple_type(mt.prim, (_0 = mt.annots) !== null && _0 !== void 0 ? _0 : []);
    }
};
...
const raw_to_contract_interface = (rci) => {
    ...
    const to_michelson_type = (rty) => {
        ...
        switch (rty.prim) {
            ...
            case "tx_rollup_l2_address": return { prim: rty.prim, annots: rty.annots };
