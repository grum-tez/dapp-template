...
const owner_one = get_account('owner1')
const owner_two = get_account('owner2')
const owner_three = get_account('owner3')
const owner_four = get_account('owner4')
const owner_five = get_account('owner5')
const owner_six = get_account('owner6')
const creator_one = get_account('creator1')
const collector_one = get_account('collector1')
const collector_two = get_account('collector2')
const collector_three = get_account('collector3')
const marketplace_one = get_account('marketplace1')
const marketplace_two = get_account('marketplace2')
const marketplace_three = get_account('marketplace3')
const minter_one = get_account('minter1')
const minter_two = get_account('minter2')
const minter_three = get_account('minter3')
