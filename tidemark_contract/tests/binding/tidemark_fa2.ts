...
export class band implements att.ArchetypeType {
    constructor(public lower: att.Tez, public upper: att.Tez) { }
    toString(): string {
        return JSON.stringify(this, null, 2);
    }
    to_mich(): att.Micheline {
        return att.pair_to_mich([this.lower.to_mich(), this.upper.to_mich()]);
    }
    equals(v: band): boolean {
        return att.micheline_equals(this.to_mich(), v.to_mich());
    }
    static from_mich(input: att.Micheline): band {
        return new band(att.Tez.from_mich((input as att.Mpair).args[0]), att.Tez.from_mich((input as att.Mpair).args[1]));
    }
}
...
export const band_mich_type: att.MichelineType = att.pair_array_to_mich_type([
    att.prim_annot_to_mich_type("mutez", ["%lower"]),
    att.prim_annot_to_mich_type("mutez", ["%upper"])
], []);
...
export const sp_ownership_asset_key_mich_type: att.MichelineType = att.prim_annot_to_mich_type("string", []);
export const sp_band_asset_key_mich_type: att.MichelineType = att.pair_array_to_mich_type([
    att.prim_annot_to_mich_type("mutez", ["%lower"]),
    att.prim_annot_to_mich_type("mutez", ["%upper"])
], []);
...
export class ownership_asset_value implements att.ArchetypeType {
    constructor(public owner_number: att.Nat, public date_purchased: Date, public owner: att.Address, public purchase_price: att.Tez, public time_held: att.Duration, public burden_contributed: att.Tez) { }
    toString(): string {
        return JSON.stringify(this, null, 2);
    }
    to_mich(): att.Micheline {
        return att.pair_to_mich([this.owner_number.to_mich(), att.date_to_mich(this.date_purchased), this.owner.to_mich(), this.purchase_price.to_mich(), this.time_held.to_mich(), this.burden_contributed.to_mich()]);
    }
...
export class sp_ownership_asset_value implements att.ArchetypeType {
    constructor(public sp_owner_number: att.Nat, public sp_date_purchased: Date, public sp_owner: att.Address, public sp_purchase_price: att.Tez, public sp_time_held: att.Duration, public sp_burden_contributed: att.Tez, public sp_fair_burden: att.Tez, public sp_balance_with_contract: att.Tez) { }
    toString(): string {
        return JSON.stringify(this, null, 2);
    }
    to_mich(): att.Micheline {
        return att.pair_to_mich([this.sp_owner_number.to_mich(), att.date_to_mich(this.sp_date_purchased), this.sp_owner.to_mich(), this.sp_purchase_price.to_mich(), this.sp_time_held.to_mich(), this.sp_burden_contributed.to_mich(), this.sp_fair_burden.to_mich(), this.sp_balance_with_contract.to_mich()]);
    }
    equals(v: sp_ownership_asset_value): boolean {
        return att.micheline_equals(this.to_mich(), v.to_mich());
    }
    static from_mich(input: att.Micheline): sp_ownership_asset_value {
        return new sp_ownership_asset_value(att.Nat.from_mich((input as att.Mpair).args[0]), att.mich_to_date((input as att.Mpair).args[1]), att.Address.from_mich((input as att.Mpair).args[2]), att.Tez.from_mich((input as att.Mpair).args[3]), att.Duration.from_mich((input as att.Mpair).args[4]), att.Tez.from_mich((input as att.Mpair).args[5]), att.Tez.from_mich((input as att.Mpair).args[6]), att.Tez.from_mich((input as att.Mpair).args[7]));
    }
}
export class sp_band_asset_value implements att.ArchetypeType {
    constructor(public sp_total_duration: att.Duration, public sp_band_fee: att.Tez) { }
    toString(): string {
        return JSON.stringify(this, null, 2);
    }
    to_mich(): att.Micheline {
        return att.pair_to_mich([this.sp_total_duration.to_mich(), this.sp_band_fee.to_mich()]);
    }
    equals(v: sp_band_asset_value): boolean {
        return att.micheline_equals(this.to_mich(), v.to_mich());
    }
    static from_mich(input: att.Micheline): sp_band_asset_value {
        return new sp_band_asset_value(att.Duration.from_mich((input as att.Mpair).args[0]), att.Tez.from_mich((input as att.Mpair).args[1]));
    }
}
export class ledger_value implements att.ArchetypeType {
    constructor(public l_token_creator: att.Address, public l_token_owner: att.Address, public l_token_balance: att.Tez, public l_tidemark: att.Tez, public l_creator_rate: att.Rational, public l_creator_fee_paid_since_last_sale: att.Tez, public l_marketplace_rate: att.Rational, public l_minter_rate: att.Rational, public l_sale_cycle_state: sale_cycle_state, public l_tidemark_duration: att.Duration, public l_grace_period_duration: att.Duration, public l_bid_number: att.Nat, public l_bids: Array<string>, public l_owner_number: att.Nat, public l_ownership: Array<string>) { }
    toString(): string {
        return JSON.stringify(this, null, 2);
    }
    to_mich(): att.Micheline {
        return att.pair_to_mich([this.l_token_creator.to_mich(), this.l_token_owner.to_mich(), this.l_token_balance.to_mich(), this.l_tidemark.to_mich(), this.l_creator_rate.to_mich(), this.l_creator_fee_paid_since_last_sale.to_mich(), this.l_marketplace_rate.to_mich(), this.l_minter_rate.to_mich(), this.l_sale_cycle_state.to_mich(), this.l_tidemark_duration.to_mich(), this.l_grace_period_duration.to_mich(), this.l_bid_number.to_mich(), att.list_to_mich(this.l_bids, x => {
    ...
    static from_mich(input: att.Micheline): ledger_value {
        return new ledger_value(att.Address.from_mich((input as att.Mpair).args[0]), att.Address.from_mich((input as att.Mpair).args[1]), att.Tez.from_mich((input as att.Mpair).args[2]), att.Tez.from_mich((input as att.Mpair).args[3]), att.Rational.from_mich((input as att.Mpair).args[4]), att.Tez.from_mich((input as att.Mpair).args[5]), att.Rational.from_mich((input as att.Mpair).args[6]), att.Rational.from_mich((input as att.Mpair).args[7]), mich_to_sale_cycle_state((input as att.Mpair).args[8]), att.Duration.from_mich((input as att.Mpair).args[9]), att.Duration.from_mich((input as att.Mpair).args[10]), att.Nat.from_mich((input as att.Mpair).args[11]), att.mich_to_list((input as att.Mpair).args[12], x => { return att.mich_to_string(x); }), att.Nat.from_mich((input as att.Mpair).args[13]), att.mich_to_list((input as att.Mpair).args[14], x => { return att.mich_to_string(x); }));
    }
}
...
export const ownership_asset_value_mich_type: att.MichelineType = att.pair_array_to_mich_type([
    ...
    att.prim_annot_to_mich_type("mutez", ["%burden_contributed"])
], []);
export const sp_ownership_asset_value_mich_type: att.MichelineType = att.pair_array_to_mich_type([
    att.prim_annot_to_mich_type("nat", ["%sp_owner_number"]),
    att.prim_annot_to_mich_type("timestamp", ["%sp_date_purchased"]),
    att.prim_annot_to_mich_type("address", ["%sp_owner"]),
    att.prim_annot_to_mich_type("mutez", ["%sp_purchase_price"]),
    att.prim_annot_to_mich_type("int", ["%sp_time_held"]),
    att.prim_annot_to_mich_type("mutez", ["%sp_burden_contributed"]),
    att.prim_annot_to_mich_type("mutez", ["%sp_fair_burden"]),
    att.prim_annot_to_mich_type("mutez", ["%sp_balance_with_contract"])
], []);
export const sp_band_asset_value_mich_type: att.MichelineType = att.pair_array_to_mich_type([
    att.prim_annot_to_mich_type("int", ["%sp_total_duration"]),
    att.prim_annot_to_mich_type("mutez", ["%sp_band_fee"])
], []);
export const ledger_value_mich_type: att.MichelineType = att.pair_array_to_mich_type([
    ...
    att.prim_annot_to_mich_type("mutez", ["%l_creator_fee_paid_since_last_sale"]),
    att.pair_array_to_mich_type([
        att.prim_annot_to_mich_type("int", []),
        att.prim_annot_to_mich_type("nat", [])
    ], ["%l_marketplace_rate"]),
...
export type sp_ownership_asset_container = Array<[
    string,
    sp_ownership_asset_value
]>;
export type sp_band_asset_container = Array<[
    band,
    sp_band_asset_value
]>;
...
export const sp_ownership_asset_container_mich_type: att.MichelineType = att.pair_annot_to_mich_type("map", att.prim_annot_to_mich_type("string", []), att.pair_array_to_mich_type([
    att.prim_annot_to_mich_type("nat", ["%sp_owner_number"]),
    att.prim_annot_to_mich_type("timestamp", ["%sp_date_purchased"]),
    att.prim_annot_to_mich_type("address", ["%sp_owner"]),
    att.prim_annot_to_mich_type("mutez", ["%sp_purchase_price"]),
...
export const sp_band_asset_container_mich_type: att.MichelineType = att.pair_annot_to_mich_type("map", att.pair_array_to_mich_type([
    att.prim_annot_to_mich_type("mutez", ["%lower"]),
    att.prim_annot_to_mich_type("mutez", ["%upper"])
], []), att.pair_array_to_mich_type([
    att.prim_annot_to_mich_type("int", ["%sp_total_duration"]),
...
const make_offer_arg_to_mich = (mo_token_id: att.Nat, mo_marketplace: att.Address): att.Micheline => {
    return att.pair_to_mich([
        mo_token_id.to_mich(),
...
export class Tidemark_fa2 {
    ...
    async make_offer(mo_token_id: att.Nat, mo_marketplace: att.Address, params: Partial<ex.Parameters>): Promise<att.CallResult> {
        if (this.address != undefined) {
            return await ex.call(this.address, "make_offer", make_offer_arg_to_mich(mo_token_id, mo_marketplace), params);
        }
        throw new Error("Contract not initialised");
    }
    ...
    async get_make_offer_param(mo_token_id: att.Nat, mo_marketplace: att.Address, params: Partial<ex.Parameters>): Promise<att.CallParameter> {
        if (this.address != undefined) {
            return await ex.get_call_param(this.address, "make_offer", make_offer_arg_to_mich(mo_token_id, mo_marketplace), params);
        }
        throw new Error("Contract not initialised");
    }
    ...
    async get_owner_one_address(): Promise<att.Address> {
        if (this.address != undefined) {
            const storage = await ex.get_raw_storage(this.address);
            return att.Address.from_mich((storage as att.Mpair).args[5]);
        }
        throw new Error("Contract not initialised");
    }
    ...
    async get_token_metadata_value(key: att.Nat): Promise<token_metadata_value | undefined> {
        if (this.address != undefined) {
            const storage = await ex.get_raw_storage(this.address);
            const data = await ex.get_big_map_value(BigInt(att.Int.from_mich((storage as att.Mpair).args[7]).toString()), key.to_mich(), token_metadata_key_mich_type);
            if (data != undefined) {
    ...
    async get_sp_ownership_asset(): Promise<sp_ownership_asset_container> {
        if (this.address != undefined) {
            const storage = await ex.get_raw_storage(this.address);
            return att.mich_to_map((storage as att.Mpair).args[10], (x, y) => [att.mich_to_string(x), sp_ownership_asset_value.from_mich(y)]);
        }
        throw new Error("Contract not initialised");
    }
    async get_sp_band_asset(): Promise<sp_band_asset_container> {
        if (this.address != undefined) {
            const storage = await ex.get_raw_storage(this.address);
            return att.mich_to_map((storage as att.Mpair).args[11], (x, y) => [band.from_mich(x), sp_band_asset_value.from_mich(y)]);
        }
        throw new Error("Contract not initialised");
    }
    async get_ledger_value(key: att.Nat): Promise<ledger_value | undefined> {
        if (this.address != undefined) {
            const storage = await ex.get_raw_storage(this.address);
            const data = await ex.get_big_map_value(BigInt(att.Int.from_mich((storage as att.Mpair).args[12]).toString()), key.to_mich(), ledger_key_mich_type);
            if (data != undefined) {
    ...
    async get_operator_value(key: operator_key): Promise<operator_value | undefined> {
        if (this.address != undefined) {
            const storage = await ex.get_raw_storage(this.address);
            const data = await ex.get_big_map_value(BigInt(att.Int.from_mich((storage as att.Mpair).args[13]).toString()), key.to_mich(), operator_key_mich_type);
            if (data != undefined) {
    ...
    async get_operator_for_all_value(key: operator_for_all_key): Promise<operator_for_all_value | undefined> {
        if (this.address != undefined) {
            const storage = await ex.get_raw_storage(this.address);
            const data = await ex.get_big_map_value(BigInt(att.Int.from_mich((storage as att.Mpair).args[14]).toString()), key.to_mich(), operator_for_all_key_mich_type);
            if (data != undefined) {
    ...
    async get_next_token_id(): Promise<att.Nat> {
        if (this.address != undefined) {
            const storage = await ex.get_raw_storage(this.address);
            return att.Nat.from_mich((storage as att.Mpair).args[15]);
        }
        throw new Error("Contract not initialised");
    }
    async get_sp_band_duration_out(): Promise<Array<[
        band,
        att.Duration
    ]>> {
        if (this.address != undefined) {
            const storage = await ex.get_raw_storage(this.address);
            return att.mich_to_map((storage as att.Mpair).args[16], (x, y) => [band.from_mich(x), att.Duration.from_mich(y)]);
        }
        throw new Error("Contract not initialised");
    }
    async get_refund_owed_list(): Promise<Array<att.Tez>> {
        if (this.address != undefined) {
            const storage = await ex.get_raw_storage(this.address);
            return att.mich_to_list((storage as att.Mpair).args[17], x => { return att.Tez.from_mich(x); });
        }
        throw new Error("Contract not initialised");
    }
    async get_metadata_value(key: string): Promise<att.Bytes | undefined> {
        if (this.address != undefined) {
            const storage = await ex.get_raw_storage(this.address);
            const data = await ex.get_big_map_value(BigInt(att.Int.from_mich((storage as att.Mpair).args[18]).toString()), att.string_to_mich(key), att.prim_annot_to_mich_type("string", []));
            if (data != undefined) {
